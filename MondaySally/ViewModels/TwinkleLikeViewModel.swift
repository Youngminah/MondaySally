//
//  TwinkleLikeViewModel.swift
//  MondaySally
//
//  Created by meng on 2021/07/19.
//

class TwinkleLikeViewModel {
    ...
    func fetchTwinkleLike(with index: Int){
        self.isLoading = true
        self.dataService?.requestFetchTwinkleLike(with: index, completion: { [weak self] response, error in
